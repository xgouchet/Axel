 ...
 * 
 */
public class AxelActivity extends Activity implements TreeNodeEventListener<XmlData>,
        OnQueryTextListener, XmlEditorListener {
...
//        }
    ...
    protected void onResume() {
        ...
        Settings.updateFromPreferences(getSharedPreferences(Constants.PREFERENCES_NAME,
                MODE_PRIVATE));
...
//        Crouton.clearCroutonsForActivity(this);
            ...
            if (extras != null) {
                switch (requestCode) {
                    ...
                    case Constants.REQUEST_EDIT_NODE:
                        getAxelApplication().getCurrentSelection().onContentChanged();
                        mEditor.setDirty();
                        break;
    ...
    public boolean onCreateOptionsMenu(final Menu menu) {
        ...
        // menu.findItem(R.id.action_node_search).setActionView(search);
    ...
    public boolean onOptionsItemSelected(final MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_help:
                startActivity(new Intent(getApplicationContext(), AxelHelpActivity.class));
                break;
            case R.id.action_preferences:
                startActivity(new Intent(getApplicationContext(), AxelSettingsActivity.class));
                break;
            case R.id.action_about:
                startActivity(new Intent(getApplicationContext(), AxelAboutActivity.class));
                break;
            default:
    ...
    // @Override
    @Deprecated
    public void onItemClick(final Object source, final int pos, final int actionId) {
        ...
        switch (actionId) {
            ...
            case R.id.action_node_comment:
                mEditor.performCommentUncomment();
                break;
            case R.id.action_node_cut:
                mEditor.performClipboardCut();
                break;
            case R.id.action_node_copy:
                mEditor.performClipboardCopy();
                break;
            case R.id.action_node_paste:
                mEditor.performClipboardPaste();
                break;
        }
    }
     ...
     */
    @Override
    public void onNodeLongPressed(final TreeNode<XmlData> node, final View view, final int position) {
     ...
     */
    @Override
    public void onNodeDoubleTapped(final TreeNode<XmlData> node, final View view, final int position) {
     ...
     */
    @Override
    public void onXmlDocumentChanged(final XmlNode root, final String name, final Uri path) {
...
//        Crouton.makeText(this, message, Style.ALERT).show();
     ...
     */
    private void performQuickAction(final TreeNode<XmlData> node, final View view,
            final String action) {
        ...
        if (Constants.QUICK_ACTION_NONE.equals(action)) {
            ...
            if (Constants.QUICK_ACTION_ADD_CHILD.equals(action)) {
                ...
                if ((!xmlNode.isDocument()) && (!xmlNode.isDocumentDeclaration())) {
                    mEditor.performCommentUncomment();
                }
...
//                Crouton.makeText(this, R.string.toast_intent_invalid_uri, Style.ALERT).show();
            } catch (IllegalArgumentException e) {
//                Crouton.makeText(this, R.string.toast_intent_illegal, Style.ALERT).show();
            }
        } else {
            mEditor.doClearContents();
        }
...
//            Crouton.makeText(this, R.string.toast_no_recent_files, Style.INFO).show();
        } else {
            mAfterSave = new Runnable() {
...
//                    Crouton.showText(AxelActivity.this, R.string.toast_preview_file_not_saved,
//                            Style.ALERT);
                }
            }
        };
...
//        startActivityForResult(saveAs, Constants.REQUEST_SAVE_AS);
    ...
    private void promptFileDeleted() {
        ...
        builder.setNeutralButton(R.string.action_save_as, new DialogInterface.OnClickListener() {
...
//        });
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(final View v) {
                        ...
                        } else if (!TemplateFiles.validateTemplateName(getApplicationContext(),
                                name)) {
    ...
    private void promptElementAddAttribute() {
        ...
        dlg.setSiblingsAttribute(mEditor.getSelection().getContent().getAttributes());
    ...
    private void doSendFile(final File file) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL,
                new String[] { getResources().getString(R.string.ui_mail) });
    ...
    private void doSortChildren() {
        ...
        Intent edit = new Intent(getApplicationContext(), AxelSortActivity.class);
    ...
    private final Callback mActionModeCallback = new Callback() {
        ...
        public boolean onCreateActionMode(final ActionMode mode, final Menu menu) {
            ...
            if (!mActiveNode.canHaveChildren()) {
                ...
                menu.removeItem(R.id.action_node_paste);
            }
            ...
            if (!mActiveNode.isElement()) {
                menu.removeItem(R.id.action_node_add_attribute);
            }

            if (!mActiveNode.canBeRemovedFromParent()) {
                menu.removeItem(R.id.action_node_cut);
                menu.removeItem(R.id.action_node_delete);
            }

            if (mActiveNode.isDocumentDeclaration()) {
                menu.removeItem(R.id.action_node_copy);
            }

            if (mActiveNode.isDocument()) {
                menu.removeItem(R.id.action_node_edit);
                menu.removeItem(R.id.action_node_comment);
            } else if (!mActiveNode.isDocumentDeclaration()) {
                if (mActiveNode.isComment()) {
                    menu.findItem(R.id.action_node_comment).setTitle(R.string.action_uncomment);
