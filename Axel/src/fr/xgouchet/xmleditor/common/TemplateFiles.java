...
public final class TemplateFiles {
    ...
    public static void copyTemplatesFromAssets(final Context context) {
        ...
        //		TODO FileUtils.copyAssetsToAppData(context, templateFolder, TEMPLATE_FOLDER);
    }
     ...
     */
    public static boolean validateTemplateName(final Context context, final String name) {
    ...
    private static File getTemplateFolder(final Context context) {
        if (sTemplateFolder == null) {
            sTemplateFolder = context.getDir(TEMPLATE_FOLDER, Context.MODE_PRIVATE);
        }
