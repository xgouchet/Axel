...
public final class Constants {
    ...
    /** Request code for ACTION_OPEN_DOCUMENT (KK+) */
    public static final int REQUEST_OPEN_DOCUMENT = 108;
    /** Request code for GET_CONTENT (ICS/JB) */
    public static final int REQUEST_GET_CONTENT = 109;
    
    
    /** Request code for Edit Node Activity */
    public static final int REQUEST_EDIT_NODE = 110;
    /** Request code for Sort Chidlren Activity */
    public static final int REQUEST_SORT_CHILDREN = 111;
