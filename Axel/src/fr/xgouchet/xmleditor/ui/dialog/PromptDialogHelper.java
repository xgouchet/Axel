...
public class PromptDialogHelper {
	...
	public static void promptHtmlParseErrorAction(final Context context,
		...
		builder.setMessage(context
				.getString(R.string.ui_prompt_open_error_html));
		...
		OnClickListener listener = new OnClickListener() {
			...
			public void onClick(final DialogInterface dialog, final int which) {
				...
				promptListener.onPromptEvent(PROMPT_HTML_PARSE_ERROR, choice,
						null);
			}
		};
	...
	public static void promptXmlParseErrorAction(final Context context,
		...
		OnClickListener listener = new OnClickListener() {
			...
			public void onClick(final DialogInterface dialog, final int which) {
				...
				promptListener.onPromptEvent(PROMPT_XML_PARSE_ERROR, choice,
						null);
			}
		};
