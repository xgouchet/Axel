...
public class ElementChildrenEditorFragment extends ANodeEditorFragment {
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		View root = inflater.inflate(R.layout.fragment_node_children_editor,
				container, false);
	...
	public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
		...
		submenu.setGroupVisible(R.id.action_group_document_add_child,
				mXmlNode.isDocument());
		submenu.setGroupVisible(R.id.action_group_element_add_child,
				mXmlNode.isElement());

		if (mXmlNode.isDocument()) {
			submenu.findItem(R.id.action_add_child_doctype).setEnabled(
					!mXmlNode.hasDoctype());
			submenu.findItem(R.id.action_add_child_element).setEnabled(
					!mXmlNode.hasRootChild());
		}
