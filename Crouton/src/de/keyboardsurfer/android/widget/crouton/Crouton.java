...
/**
 * Displays information in a non-invasive context related manner. Like {@link android.widget.Toast},
 * but better.
 * <p/>
 * <b>Important: </b> Call {@link Crouton#clearCroutonsForActivity(Activity)} within
...
public final class Crouton {
     ...
     */
    private Crouton(final Activity activity, final CharSequence text, final Style style) {
     ...
     * 
     * @param activity
     *            The {@link Activity} that represents the context in which the Crouton should
     *            exist.
     * @param text
     *            The text you want to display.
     * @param style
     ...
     */
    private Crouton(final Activity activity, final CharSequence text, final Style style, final ViewGroup viewGroup) {
        if ((activity == null) || (text == null) || (style == null)) {
            throw new IllegalArgumentException(NULL_PARAMETERS_ARE_NOT_ACCEPTED);
        }
     ...
     */
    public static Crouton makeText(final Activity activity, final CharSequence text, final Style style) {
     ...
     *            The resource id of the {@link ViewGroup} that this {@link Crouton} should be added
     *            to.
     * 
     * @return The created {@link Crouton}.
     */
     ...
     * @return The created {@link Crouton}.
     */
    public static Crouton makeText(final Activity activity, final int textResourceId, final Style style) {
     ...
     *            The style that this {@link Crouton} should be created with.
     */
    public static void showText(final Activity activity, final CharSequence text, final Style style) {
     ...
     */
    public static void showText(final Activity activity, final CharSequence text, final Style style,
            final int viewGroupResId, final Configuration configuration) {
     ...
     *            The style that this {@link Crouton} should be created with.
     */
    public static void showText(final Activity activity, final int textResourceId, final Style style) {
     ...
     */
    public void setLifecycleCallback(final LifecycleCallback lifecycleCallback) {
    ...
    /**
     * Allows setting of an {@link OnClickListener} directly to a {@link Crouton} without having to
     * use a custom view.
     * 
    ...
    public String toString() {
        return "Crouton{" + "text=" + text + ", style=" + style + ", configuration="
                + configuration + ", customView=" + customView + ", onClickListener="
                + onClickListener + ", activity=" + activity + ", viewGroup=" + viewGroup
                + ", croutonView=" + croutonView + ", inAnimation=" + inAnimation
                + ", outAnimation=" + outAnimation + ", lifecycleCallback=" + lifecycleCallback
                + '}';
    }
    ...
    private void measureCroutonView() {
        ...
        if (viewGroup != null) {
            ...
            widthSpec = View.MeasureSpec.makeMeasureSpec(activity.getWindow().getDecorView()
                    .getMeasuredWidth(), View.MeasureSpec.AT_MOST);
        }
